...
{
    /// <summary>
    /// Logika interakcji dla klasy AddPlToEn.xaml
    /// </summary>
    public partial class AddPlToEn : Page
    {
        Settings settings;
        ...
        public AddPlToEn(Settings settings, List<Question> polishToEnglish, List<Question> englishToPolish, List<QuizQuestion> quiz)
        {
        ...
        private void Save(object sender, RoutedEventArgs e)
        {
            ...
            Logic.AddTranslation(polishToEnglish, word.Text, list);
